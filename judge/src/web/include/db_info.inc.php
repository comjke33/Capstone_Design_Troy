...
// $DB_PASS="JGqRe4pltka5e5II4Di3YZdmxv7SGt"; 里面放的密码是安装是随机生成的，请不要泄露，最好也不要随意修改为低强度的其他密码，您在linux命令行可以用sudo mysql直接以root身份登录mysql。
// connect db 
static 	$DB_HOST="localhost";  //数据库服务器ip或域名
static 	$DB_NAME="jol";   //数据库名
static 	$DB_USER="hustoj";  //数据库账户
static 	$DB_PASS="JGqRe4pltka5e5II4Di3YZdmxv7SGt";  //数据库密码

static 	$OJ_NAME="TroyOJ";  //左上角显示的系统名称, 尽量简洁，避免用中文和空格，如需中文、长字符串、图片，可以直接修改template/syzoj/header.php
static 	$OJ_HOME="./";    //主页目录
...
static  $OJ_LANG="ko";  //默认语言, 中文修改为"cn"
