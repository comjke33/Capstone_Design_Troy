...
<div class="main-layout" style="display: flex; justify-content: space-between; gap: 20px;">
    ...
    <!-- 왼쪽 패널 -->
    <div class="left-panel" style="flex: 0.2; padding-right: 10px; position: relative; display: flex; justify-content: center; align-items: center;">
        <div id="slider-container" style="position: relative; height: 100%; width: 100px;">
            <img src="/image/feedback.jpg" alt="Feedback" id="feedback-img"
                 style="width: 100px; height: 100px; object-fit: cover; border-radius: 10px; position: absolute; top: 0;">
        </div>
    </div>
