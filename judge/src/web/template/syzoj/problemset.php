  ...
  <div class="ui centered grid">
    <div class="ten wide column">
      ...
      <form action="problem.php" method="get" class="ui form">
        <div class="ui fluid action input jump-box">
          <input
            type="text"
            name="id"
  ...
  <table class="ui very basic center aligned table">
    ...
    <tbody>
      ...
      foreach ($result as $row) {
        ...
        echo "<a style=\"vertical-align: middle;\" href=\"problem.php?id=" . $row['problem_id'] . "\">" . $row['title'] . "</a>";
        if ($row['defunct'] == 'Y') {
        ...
        if ($row['submit'] == 0) {
          echo '<td><div class="progress"><div class="progress-bar progress-bar-danger" role="progressbar" style="width:0%;">0.000%</div></div></td>';
        } else {
          $percentage = round(100 * $row['accepted'] / $row['submit'], 3);
          echo '<td><div class="progress"><div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" style="width:' . $percentage . '%;">' . $percentage . '%</div></div></td>';
        }
        echo "</tr>";
        $i++;
      }
