  ...
  <div class="row" id="submit-buttons"> 
    <div class="column">
      ...
      if (!isset($cid) && in_array($_SESSION[$OJ_NAME.'_'.'user_id'], $allowed_user_id)) {
            ...
            echo "<a class=\"small ui black button\" href=\"debug_submit.php?problem_id=$id\">결함코드 풀기</a>";
      }
...
<style>
  ...
  top:350px;
  left: 0;
  cursor: col-resize; /* 너비 조정 가능한 커서를 표시 */
}
</style>
...
$(document).ready(function() {
    ...
    // 마우스를 페이지 밖으로 이동하거나 포커스가 벗어나면 드래그가 멈추고 원래 색으로 돌아감
