    ...
    <div id="page-header" class="ui" style="position: relative; height: 49px; z-index:99999">
        <div id="menu" class="menu-container">
          ...
          ?>
            ...
            <a class="item <?php if ($url=="strategy.php") echo "active";?>" href="<?php echo $path_fix?>strategy.php"><i
            ...
            <div class="right menu">
                ...
                <div class="ui simple dropdown item">
                    ...
                    <div class="menu">
                        <!-- ✅ 내 정보 항목 추가 -->
                        <a class="item" href="<?php echo $path_fix?>/userinfo.php?user=<?php echo $_SESSION[$OJ_NAME.'_'.'user_id'] ?>">
                            <i class="user icon"></i> 내 정보
                        </a>
